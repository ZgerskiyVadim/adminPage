...
export const USER_LEFT_GROUP_SUCCESS = 'USER_LEFT_GROUP_SUCCESS';
export const USER_JOINED_GROUP_SUCCESS = 'USER_JOINED_GROUP_SUCCESS';
export const GET_USER_PENDING = 'GET_USER_PENDING';
export const UPDATE_USER_SUCCESS = 'UPDATE_USER_SUCCESS';
export const UPDATE_USER_PENDING = 'UPDATE_USER_PENDING';
export const LEAVE_GROUP_PENDING = 'LEAVE_GROUP_PENDING';
export const ADD_USER_IN_GROUP_PENDING = 'ADD_USER_IN_GROUP_PENDING';
